...
export function HomeHero() {
  return (
    <section className="relative h-[370px] overflow-hidden bg-white md:h-[500px] lg:h-[560px] 2xl:h-[620px]">
      ...
      <div
        className="absolute inset-x-0 top-[101px] h-[105px] bg-white md:top-[165px] md:h-[300px] lg:top-[215px] lg:h-[340px] 2xl:top-[245px] 2xl:h-[390px]"
      ...
      <div className="relative mx-auto h-full max-w-[570px] md:max-w-[1512px]">
        <Image
          ...
          height={659}
          priority
          className="absolute left-[5px] top-[100px] z-10 w-55"
        />

        <div className="absolute right-[55px] top-[115px] z-20 max-w-[205px] text-primary max-[480px]:right-[18px] max-[480px]:top-[130px] max-[480px]:max-w-[145px] max-[360px]:right-[14px] max-[360px]:max-w-[130px] md:right-[8%] md:top-[210px] md:max-w-[340px] lg:right-[11%] lg:top-[275px] lg:max-w-[390px] xl:right-[12.5%]">
